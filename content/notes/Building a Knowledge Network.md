---
title: Building a Knowledge Network
description: Notes on how the pieces of Notes on Being Human connect.
type: note
...
The site is meant to grow as a network of connected writing rather than as a collection of isolated articles.

A useful pattern is to let one piece lead naturally to another: a question can point to an essay, an essay can point to a case story, and a note can capture an idea that later becomes a fuller piece.

The folders organise the writing. The links connect it.
